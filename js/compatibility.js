...
const DRUGS = window.COMPAT_DRUGS;  // dataset moved to js/compat-drugs.js (shared with interactions page)
...
// ===== MODE SWITCHING =====
// Pharmacological drug-interaction (DDI) is a SEPARATE page now (interactions.html);
// this page only switches between the compatibility check and the matrix view.
