...
var IVDrugRef = (function() {
  ...
  const RELEASE_NOTES = [
    ...
    },
    {
      ...
      items: [
        "กดแชร์แล้วถ้ายังไม่เคยอนุญาต แอปจะขอสิทธิ์ให้อัตโนมัติ แล้วเปิดหน้าต่างเลือกแชตต่อ",
        "ถ้าไม่อนุญาต ยังคัดลอกให้เหมือนเดิม และจะไม่ถามซ้ำทุกครั้ง"
      ]
    },
    {
      v: '5.86.0',
    ...
    },
    {
      ...
      items: [
        "ปุ่มแชร์ LINE (หน้าคำนวณ/แพ้ยา/TDM) เปลี่ยนจากคัดลอกข้อความ เป็นเลือกแชตแล้วส่งได้เลยเมื่อเปิดผ่าน LINE",
        "บนมือถือทั่วไปจะเด้งเข้า LINE พร้อมข้อความให้ทันที ส่วนคอมพิวเตอร์ยังคัดลอกเหมือนเดิม"
      ]
    },
    {
      v: '5.81.0',
      date: '2026-07-31',
      title: "ส่งประกาศด่วนเข้า LINE ได้แล้ว 📣",
      items: [
        "หน้าประกาศด่วนใน Admin เพิ่มตัวเลือก 'ส่งเข้า LINE ด้วย' — กระจายถึงผู้ติดตาม LINE OA ทันที",
        "แสดงโควตาคงเหลือและประเมินยอดที่จะใช้ก่อนส่งทุกครั้ง (แพ็กเกจฟรี 300 ข้อความ/เดือน)",
        "ถ้าส่ง LINE ไม่สำเร็จ ประกาศในแอปยังส่งถึงผู้ใช้ตามปกติ"
      ]
    },
    {
      v: '5.80.0',
      date: '2026-07-31',
      title: "ขอความเห็นผู้ใช้ (NPS) ให้ถามง่ายขึ้น",
      items: [
        "แก้แบบสอบถามความพึงพอใจที่แทบไม่เคยเด้งเลย (เดิมต้องเข้าใช้งานครบ 5/10/20 ครั้งพอดีเป๊ะ ถ้าเลยไปแล้วจะไม่ถามอีกเลย)",
        "ตอนนี้ถามตั้งแต่ใช้งานครั้งที่ 3 เป็นต้นไป และถ้ากด 'ไว้ภายหลัง' จะเว้น 14 วันค่อยถามใหม่ (ตอบแล้วเว้น 90 วันเหมือนเดิม)",
        "ยังไม่รบกวนระหว่างค้นหายาเหมือนเดิม"
      ]
    },
    {
      v: '5.79.5',
