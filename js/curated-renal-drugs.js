const CURATED_RENAL_DRUGS = [
  ...
  {id:'allopurinol',name:'Allopurinol','class':'misc',sub:'Xanthine Oxidase Inhibitor',badges:['misc','renal'],
    recommended:'เริ่ม 50-100 mg/day → titrate สู่ urate <6',
    dosingTable:[
      {range:'>60',dose:'100 mg start',freq:'q24h',note:'Titrate ขึ้นสู่ urate <6'},
      {range:'30–60',dose:'50-100 mg start',freq:'q24h',note:'Titrate ขึ้นได้เกิน cap (monitor)'},
      {range:'15–30',dose:'50 mg start',freq:'q24h',note:'Titrate ขึ้นได้เกิน cap (monitor)'},
      {range:'<15 / HD',dose:'50 mg start',freq:'q24h',note:'Titrate ช้า ๆ; HD: post-HD'}
    ],
