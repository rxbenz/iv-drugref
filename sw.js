// ============================================================================
// IV Drug Reference PWA — Service Worker v5.88.1
...
// v5.53.0: เตรียมช่องทาง LINE 🟢
// v5.54.0: เชื่อมช่องทาง LINE — เช็คคู่ยา/ไต 🔗
// v5.55.0: แก้แถบเวอร์ชันเด้งซ้ำใน LINE
// v5.56.0: แพ้ยาหลายชนิด + ตรวจว่าใช้ยาได้ไหม
...
// v5.67.0: ปิดช่องโหว่ปลอมตัวเป็นแอดมิน (ขั้นเตรียมพร้อม)
...
// v5.72.0: แก้: การแก้ข้อมูลยาที่มีเนื้อหายาวถูกทิ้งเงียบ ๆ
...
// v5.79.3: แก้ตาราง 'ยาที่ค้นแล้วไม่มีในฐานข้อมูล'
// v5.79.4: แก้ตาราง 'ยาที่ดูบ่อย' ใน Dashboard
// v5.79.5: ระบบเก็บ error ใช้งานได้จริง
// v5.80.0: ขอความเห็นผู้ใช้ (NPS) ให้ถามง่ายขึ้น
// v5.81.0: ส่งประกาศด่วนเข้า LINE ได้แล้ว 📣
// v5.82.0: แชร์ผลเข้า LINE ได้ตรง ๆ แล้ว 📤
// v5.83.0: แก้ลิงก์เมนู LINE ให้เปิดถูกหน้า
// v5.83.1: แก้ปุ่มเมนู LINE โหลดวน
// v5.84.0: แก้ปุ่มเมนู LINE เด้งวนที่หน้าล็อกอิน
// v5.85.0: เพิ่มปุ่มแชร์ LINE ในหน้าคำนวณขนาดยา
// v5.86.0: เพิ่มโหมดตรวจหาสาเหตุปุ่มแชร์ LINE
// v5.87.0: ปุ่มแชร์ LINE ขออนุญาตให้เองแล้ว
// v5.88.0: ปุ่มแชร์ LINE เรียกหน้าต่างเลือกแชตตรง ๆ
// v5.88.1: เพิ่มตัวตรวจโหมดการเปิดหน้า (สำหรับผู้ดูแล)
// ============================================================================

const CACHE_NAME = 'iv-drugref-v5.88.1';
